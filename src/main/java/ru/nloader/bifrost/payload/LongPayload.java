 ...
 *
 * This file (LongPayload.java) is part of bifrost.
 *
 ...
 */
public class LongPayload extends AbstractPayload<Long> {
    @Override
    ...
    public boolean equals(Object anotherObj) {
        ...
        return this.hashCode() == anotherObj.hashCode() || getValue().equals(((LongPayload) anotherObj).getValue());
    }
}
