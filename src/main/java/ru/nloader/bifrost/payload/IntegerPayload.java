 ...
 *
 * This file (IntegerPayload.java) is part of bifrost.
 *
...
public class IntegerPayload extends AbstractPayload<Integer> {
    ...
    public IntegerPayload(Integer value) {
        super(value);
    }
    ...
    public boolean equals(Object anotherObj) {
        ...
        return this.hashCode() == anotherObj.hashCode() || getValue().equals(((IntegerPayload) anotherObj).getValue());
    }
}
