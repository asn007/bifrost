 ...
 *
 * This file (FloatPayload.java) is part of bifrost.
 *
 ...
 */
public class FloatPayload extends AbstractPayload<Float> {
    @Override
    ...
    public boolean equals(Object anotherObj) {
        ...
        return this.hashCode() == anotherObj.hashCode() || getValue().equals(((FloatPayload) anotherObj).getValue());
    }
}
