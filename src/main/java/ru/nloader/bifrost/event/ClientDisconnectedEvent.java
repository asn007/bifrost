 ...
 *
 * This file (ClientDisconnectedEvent.java) is part of bifrost.
 *
 ...
 */
public class ClientDisconnectedEvent implements IEvent<ClientChannelHandler, ClientChannelHandler> {
    private final ClientChannelHandler worker;
    public ClientDisconnectedEvent(ClientChannelHandler worker) {
        this.worker = worker;
    }
