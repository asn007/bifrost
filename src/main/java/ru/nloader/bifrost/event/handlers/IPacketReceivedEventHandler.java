 ...
 *
 * This file (IPacketReceivedEventHandler.java) is part of bifrost.
 *
 ...
 */
@FunctionalInterface
public interface IPacketReceivedEventHandler {
    public void onPacketReceived(PacketReceivedEvent evt) throws Exception;
}
